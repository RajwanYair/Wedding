/**
 * src/services/commerce.js — S264 merged commerce service
 *
 * Merged from:
 *   - commerce-service.js (S241) — expense + vendor CRUD + budget summary
 *   - stripe-checkout.js  (S114) — Stripe Checkout integration stub
 *
 * §1 Commerce: addExpense, getExpenses, getBudgetUsed, getOverBudget,
 *    markVendorPaid, getBudgetSummary, getVendorPaymentRate
 * §2 Stripe: createCheckoutSession, getCheckoutStatus
 *
