...
export const VENDOR_CATEGORY_OPTIONS = /** @type {const} */ ([
  ...
  { value: "photography",  labelKey: "vendor_cat_photography",  color: "var(--color-neutral)", icon: "📷" },
  ...
  { value: "transport",    labelKey: "vendor_cat_transport",    color: "var(--color-neutral)", icon: "🚌" },
...
export const EXPENSE_CATEGORY_OPTIONS = /** @type {const} */ ([
  ...
  { value: "catering",    labelKey: "expense_cat_catering",    color: "var(--color-neutral)", icon: "🍴" },
  { value: "photography", labelKey: "expense_cat_photography", color: "var(--color-neutral)", icon: "📷" },
  ...
  { value: "transport",   labelKey: "expense_cat_transport",   color: "var(--color-neutral)", icon: "🚌" },
...
export const TIMELINE_CATEGORY_OPTIONS = /** @type {const} */ ([
  ...
  { value: "reception",   labelKey: "timeline_cat_reception",   color: "var(--color-gold)",    icon: "🥂" },
  { value: "preparation", labelKey: "timeline_cat_preparation", color: "var(--color-blue)",    icon: "💄" },
  { value: "transport",   labelKey: "timeline_cat_transport",   color: "var(--color-neutral)", icon: "🚐" },
  { value: "meal",        labelKey: "timeline_cat_meal",        color: "var(--color-green)",   icon: "🍽️" },
  { value: "photography", labelKey: "timeline_cat_photography", color: "var(--color-purple)",  icon: "📷" },
...
export const CAMPAIGN_TYPE_OPTIONS = /** @type {const} */ ([
  { value: "whatsapp", labelKey: "campaign_type_whatsapp", color: "var(--color-green)",   icon: "💬" },
...
export const DELIVERY_STATUS_OPTIONS = /** @type {const} */ ([
  ...
  { value: "delivered", labelKey: "delivery_status_delivered", color: "var(--color-success)", icon: "✅" },
  ...
  { value: "bounced",   labelKey: "delivery_status_bounced",   color: "var(--color-warning)", icon: "↩️" },
]);
