...
vi.mock("../../src/sections/settings.js", () => ({
  ...
  findGuestDuplicates: () => _findGuestDuplicatesMock(),
  mergeGuestDuplicate: (el) => _mergeGuestDuplicateMock(el),
}));
...
const _findGuestDuplicatesMock = vi.fn();
const _mergeGuestDuplicateMock = vi.fn();
...
describe("S329 — settingsHandlers — register()", () => {
  it("registers all expected handlers", () => {
    ...
    const expected = [
      ...
      "saveSupabaseConfig",
      "saveBackendType",
      "supabaseCheckConnection",
      "conflictAcceptAllLocal",
      "conflictAcceptAllRemote",
      "conflictApplySelected",
