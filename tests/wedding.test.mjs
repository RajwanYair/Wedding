// =============================================================================
// Wedding Manager — Repo Sanity Suite v8.0.2
...
describe("Version alignment", function () {
  it("package.json is v8.0.2", function () {
    assert.equal(packageJson.version, "8.0.2");
  });

  it("src/core/config.js exports APP_VERSION v8.0.2", function () {
    assert.ok(read("src/core/config.js").includes('APP_VERSION = "8.0.2"'));
  });

  it("public/sw.js uses wedding-v8.0.2 cache", function () {
    assert.ok(serviceWorker.includes("wedding-v8.0.2"));
  });

  it("README version badge references v8.0.2", function () {
    assert.ok(readme.includes("version-v8.0.2"));
  });
});
