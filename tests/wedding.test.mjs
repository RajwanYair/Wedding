...
describe("Version", function () {
  it("src/core/config.js contains v7.0.0", function () {
    ...
    assert.ok(cfg.includes("7.7.0"));
  });

  it("SW cache name contains v7.7.0", function () {
    assert.ok(SW.includes("wedding-v7.7.0"));
  });

  it("package.json version is 7.7.0", function () {
    assert.equal(PKG.version, "7.7.0");
  });
});
