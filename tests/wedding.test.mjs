// =============================================================================
// Wedding Manager — Repo Sanity Suite v32.2.1
...
describe("Version alignment", function () {
  it("package.json is v32.2.1", function () {
    assert.equal(packageJson.version, "32.2.1");
  });

  it("src/core/config.js exports APP_VERSION v32.2.1", function () {
    assert.ok(read("src/core/config.js").includes('APP_VERSION = "32.2.1"'));
  });

  it("public/sw.js uses wedding-v32.2.1 cache", function () {
    assert.ok(serviceWorker.includes("wedding-v32.2.1"));
  });

  it("README version badge references v32.2.1", function () {
    assert.ok(readme.includes("version-v32.2.1"));
  });

  it("Copilot instructions title references v32.2.1", function () {
    assert.ok(
  ...
  it("ARCHITECTURE.md header references v32.2.1", function () {
    assert.ok(architecture.includes("# Wedding Manager — Architecture (v32.2.1)"));
  });

  it("src/types.d.ts header references v32.2.1", function () {
    assert.ok(
