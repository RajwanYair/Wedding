  ...
  <div class="settings-grid">
    ...
    <div class="settings-card">
      ...
      <div class="sheets-actions">
        ...
        <!-- Phase 7.5 Sheets Mirror via Edge Function toggle -->
        <div class="live-sync-row">
          <label class="toggle-label">
            <input type="checkbox" id="sheetsMirrorToggle" data-action="toggleSheetsMirror">
            <span data-i18n="sheets_mirror_label">שיקוף ל-Sheets דרך Edge Function</span>
          </label>
        </div>
      </div>
    ...
    <div class="settings-card">
      ...
      <div class="transport-grid">
        ...
        <div class="form-group">
          <label class="transport-label" data-i18n="transport_time_ph"
            >שעת יציאה</label
          >
    ...
    <div class="settings-card settings-card--full">
      ...
      <div class="settings-btn-row">
        <button class="btn btn-secondary btn-small" data-action="refreshAuditLog">
          🔄 <span data-i18n="audit_refresh_btn">טען מ-Supabase</span>
        </button>
    ...
    <!-- S15.3 Auto-Backup -->
    <div class="settings-card">
      <h3>💾 <span data-i18n="autobackup_title">גיבוי אוטומטי</span></h3>
      <p data-i18n="autobackup_desc">גיבוי אוטומטי שומר תמונת מצב כל 30 דקות.</p>
      <div class="form-row">
        <div class="form-group">
          <label data-i18n="autobackup_interval">מרווח (דקות)</label>
          <input type="number" id="autoBackupInterval" min="5" max="240" value="30" inputmode="numeric" />
        </div>
        <div class="form-group">
          <span class="badge" id="lastBackupTime" data-i18n="autobackup_never">טרם בוצע</span>
        </div>
      </div>
      <div class="section-toolbar-start">
        <button class="btn btn-primary btn-small" data-action="startAutoBackup">
          ▶ <span data-i18n="autobackup_start">הפעל גיבוי</span>
        </button>
        <button class="btn btn-secondary btn-small" data-action="stopAutoBackup">
          ⏹ <span data-i18n="autobackup_stop">עצור גיבוי</span>
        </button>
        <button class="btn btn-secondary btn-small" data-action="downloadAutoBackup">
          📥 <span data-i18n="autobackup_download">הורד גיבוי</span>
        </button>
        <button class="btn btn-secondary btn-small" data-action="restoreAutoBackup">
    ...
    <!-- Phase 10.1 — WhatsApp Cloud API -->
    <div class="settings-card" id="waCloudCard">
      <h3>🟢 <span data-i18n="wa_cloud_title">WhatsApp Cloud API</span></h3>
      <p data-i18n="wa_cloud_desc">
        שלח הודעות דרך WhatsApp Cloud API — צור Edge Function בסופאבייס עם
        WA_ACCESS_TOKEN ו-WA_PHONE_NUMBER_ID כ-Secrets.
      </p>
      <div class="sheets-url-row">
        <label for="waPhoneNumberId" class="sheets-label" data-i18n="wa_phone_number_id_label">Phone Number ID</label>
        <input
          type="text"
          id="waPhoneNumberId"
          class="form-input"
          data-i18n-placeholder="ph_wa_phone_number_id"
          autocomplete="off"
        >
        <button class="btn btn-secondary" data-action="saveWaCloudSettings">
          <span data-i18n="wa_cloud_save_btn">שמור</span>
        </button>
      </div>
      <p class="text-hint" data-i18n="wa_cloud_hint">
        ה-Token נשמר רק בסביבת Supabase Edge Function (לא בדפדפן).
      </p>
    </div>
...
`;export{t};
//# sourceMappingURL=template-settings-Nqnvaoyn.js.map