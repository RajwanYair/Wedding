  ...
  <div class="rsvp-hero">
    ...
    <div class="rsvp-form">
      ...
      <div class="form-group">
        <label for="rsvpPhone" data-i18n="rsvp_phone">טלפון</label>
      ...
      <div id="rsvpDetails" class="u-hidden">
        <div class="form-row">
          <div class="form-group">
            <label for="rsvpFirstName" data-i18n="label_first_name">שם פרטי *</label>
            <input
              type="text"
              id="rsvpFirstName"
          ...
          <div class="form-group">
            <label for="rsvpLastName" data-i18n="label_last_name">שם משפחה</label>
            <input
              type="text"
              id="rsvpLastName"
        ...
        <div class="form-group">
          <label for="rsvpSide" data-i18n="rsvp_side">בצד של</label>
          <select id="rsvpSide">
        ...
        <div class="form-group">
          <label for="rsvpAttending" data-i18n="rsvp_attending">האם מגיע/ה?</label>
        ...
        <div class="form-row">
          <div class="form-group">
            <label for="rsvpGuests" data-i18n="rsvp_plus">מספר מלווים (כולל אותך)</label>
            <input
              type="number"
              id="rsvpGuests"
              min="1"
          ...
          <div class="form-group">
            <label for="rsvpChildren" data-i18n="rsvp_children">ילדים</label>
            <input
              type="number"
              id="rsvpChildren"
              min="0"
        ...
        <div class="form-group">
          <label for="rsvpMeal" data-i18n="rsvp_meal">סוג ארוחה</label>
          <select id="rsvpMeal">
        ...
        <div class="form-group">
          <label for="rsvpTransport" data-i18n="rsvp_transport">הסעה</label>
        ...
        <div class="form-group">
          <label for="rsvpNotes" data-i18n="rsvp_notes">הערות / מגבלות תזונה</label>
          <textarea
            id="rsvpNotes"
            rows="3"
...
`;export{e as default};
//# sourceMappingURL=rsvp-CXxtpvso.js.map