...
>
  <div class="modal modal--wide">
    ...
    <div class="form-row">
      <div class="form-group">
        <label data-i18n="label_guest_status">סטטוס</label>
      ...
      <div class="form-group">
        <label data-i18n="label_rsvp_source">מקור אישור</label>
    ...
    <div class="form-row">
      <div class="form-group" data-i18n-tooltip="tip_guest_count">
        <label data-i18n="label_guest_count">כמות מוזמנים (כולל)</label>
        <input
          type="number"
          id="guestCount2"
          min="1"
      ...
      <div class="form-group" data-i18n-tooltip="tip_guest_children">
        <label data-i18n="label_children">ילדים</label>
        <input
          type="number"
          id="guestChildren"
          min="0"
    ...
    <div class="form-row">
      <div class="form-group">
        <label data-i18n="label_guest_group">קבוצה</label>
    ...
    <div class="form-row">
      <div class="form-group">
        <label data-i18n="label_meal">ארוחה</label>
        <select id="guestMeal">
    ...
    <div class="form-group" data-i18n-tooltip="tip_guest_transport">
      <label data-i18n="label_transport">הסעה</label>
    ...
    <div class="form-row">
      <div class="form-group">
        <label data-i18n="label_guest_table">שולחן</label>
    ...
    <div class="modal-section-title">
      <span class="sec-icon">🏷️</span>
      <span data-i18n="guest_tags_title">תגיות</span>
    </div>
    <div class="form-row">
      <div class="form-group u-flex-1">
        <input type="text" id="guestTagInput" data-i18n-placeholder="guest_tag_ph" placeholder="הוסף תגית..." maxlength="30" data-on-enter="addGuestTag" />
      </div>
      <button class="btn btn-small btn-secondary" data-action="addGuestTag">➕</button>
    </div>

    <!-- S13.5 Guest Notes Timeline -->
    <div class="modal-section-title">
      <span class="sec-icon">📝</span>
      <span data-i18n="guest_notes_title">הערות ותיעוד</span>
    </div>
    <div class="form-row">
      <div class="form-group u-flex-1">
        <input type="text" id="guestNoteInput" data-i18n-placeholder="guest_note_ph" placeholder="הוסף הערה..." maxlength="500" data-on-enter="addGuestNote" />
      </div>
      <button class="btn btn-small btn-secondary" data-action="addGuestNote">➕</button>
    </div>
...
`;export{e as default};
//# sourceMappingURL=guestModal-DegAVVAE.js.map