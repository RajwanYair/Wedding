var e=`<div class="modal">
  <div class="modal-header">
    ...
    <button class="modal-close" data-action="closeModal" data-action-arg="conflictModal" aria-label="סגור" data-i18n-aria="btn_close">&times;</button>
    </div>
  ...
  <div class="modal-footer">
    <button class="btn btn-secondary" data-action="conflictAcceptAllLocal" data-i18n="conflict_keep_local" autofocus>שמור מקומי</button>
...
`;export{e as default};
//# sourceMappingURL=conflictModal-CctmB2Ns.js.map