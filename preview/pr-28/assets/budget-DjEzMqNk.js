...
<!-- Sprint 27 / C1: Top expense categories analytics panel -->
<div class="card" id="expenseTopCategoriesCard">
  <div class="card-header">
    <span class="icon">🏆</span>
    <span data-i18n="expense_top_categories">קטגוריות הוצאות עיקריות</span>
  </div>
  <div id="expenseTopCategories"></div>
</div>

<!-- Sprint 28 / C1: Budget envelope summaries panel -->
<div class="card" id="budgetEnvelopeSummaryCard">
  <div class="card-header">
    <span class="icon">📦</span>
    <span data-i18n="budget_envelopes_title">מעטפות תקציב</span>
  </div>
  <div id="budgetEnvelopeSummary"></div>
</div>

<!-- S606 / C1: Vendor payment milestones outlook -->
<div class="card" id="vendorMilestonesCard" hidden>
  <div class="card-header">
    <span class="icon">💳</span>
    <span data-i18n="vendor_milestones_title">תשלומי ספקים — אבני דרך</span>
  </div>
  <p id="vendorMilestonesSummary" class="u-text-sm u-text-muted"></p>
  <ul id="vendorMilestonesList" class="vendor-milestones-list"></ul>
</div>

<!-- C1: Budget Burn-Down Chart (budget-burndown.js, Sprint 46) -->
<div class="card" id="budgetBurndownCard">
  <div class="card-header">
    <span class="icon">📉</span>
    <span data-i18n="budget_burndown_title">צריכת תקציב מצטברת</span>
  </div>
  <div id="budgetBurndownChart"></div>
  <p id="budgetBurndownPct" class="u-text-sm u-text-muted u-mt-xs"></p>

  <!-- S145: Projection overlay -->
  <div id="budgetProjectionPanel" class="budget-projection-panel u-hidden u-mt-sm">
    <div class="budget-projection-row">
      <span data-i18n="budget_proj_daily_burn">צריכה יומית ממוצעת</span>
      <strong id="projDailyBurn">—</strong>
    </div>
    <div class="budget-projection-row">
      <span data-i18n="budget_proj_projected_spend">צפי הוצאות כולל</span>
      <strong id="projProjectedSpend">—</strong>
    </div>
    <div id="projOverrunRow" class="budget-projection-row budget-projection-row--warn u-hidden">
      <span data-i18n="budget_proj_overrun">חריגה צפויה</span>
      <strong id="projOverrun">—</strong>
    </div>
  </div>
</div>
`;export{e as default};
//# sourceMappingURL=budget-DjEzMqNk.js.map