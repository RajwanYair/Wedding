var e=`<div class="card">
  ...
  <div class="checkin-toolbar">
    ...
    <button class="btn btn-secondary btn-small" data-action="printGuestQrBadges">
      <span>🖨️</span> <span data-i18n="checkin_print_qr_badges">הדפס תגי QR</span>
    </button>
  </div>
  <!-- S12.3 QR Scanner Viewport -->
  <div id="qrScannerBox" class="qr-scanner-box u-hidden">
    <!-- playsinline is required for iOS Safari inline video; Firefox ignores it gracefully -->
...
`;export{e as default};
//# sourceMappingURL=checkin-B8cq5VIa.js.map