var e=`<div class="card">
  <div class="card-header">
    ...
    <div class="u-mr-auto">
      ...
      <button class="btn btn-secondary btn-small" data-action="printGuestList">
        <span>🖨️</span> <span data-i18n="btn_export_pdf_guests">ייצא PDF</span>
      </button>
      <button class="btn btn-secondary btn-small" data-action="openPrintPreview">
        <span>📋</span> <span data-i18n="print_preview_open">תצוגה מקדימה</span>
      </button>
    </div>
  </div>
  ...
  <div class="batch-toolbar u-hidden" id="batchToolbar">
    ...
    <select id="batchStatusSelect" class="u-mr-sm" data-i18n-aria="batch_set_status">
  ...
  <div class="guest-table-wrap">
    <table class="guest-table" id="guestTable">
      <thead>
        <tr>
          <th class="th-checkbox"><input type="checkbox" id="selectAllGuests" data-action="toggleSelectAll"
              data-i18n-aria="a11y_select_all" /></th>
          <th
            id="th-firstName"
...
`;export{e as default};
//# sourceMappingURL=guests-2R45eZ1c.js.map