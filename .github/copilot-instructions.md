...
| Tests | `npm test` — **1915+ pass (39 suites)** · 0 Node warnings |
...
tests/               # 1915+ tests: wedding.test.mjs + 38 unit/integration files
...
| 2 | **Zero test failures** | `npm test` — all 1915+ pass, 0 skipped |
