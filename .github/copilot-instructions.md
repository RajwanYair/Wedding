...
| Tests | `npm test` — **3152+ pass (106 suites)** · 0 Node warnings |
...
tests/               # 3021+ tests: wedding.test.mjs + 94 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3021+ pass, 0 skipped |
