...
| Tests | `npm test` — **3844+ pass (158 suites)** · 0 Node warnings |
...
tests/               # 3844+ tests: wedding.test.mjs + 157 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3844+ pass, 0 skipped |
