...
| Tests | `npm test` — **3667+ pass (147 suites)** · 0 Node warnings |
...
tests/               # 3667+ tests: wedding.test.mjs + 146 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3667+ pass, 0 skipped |
