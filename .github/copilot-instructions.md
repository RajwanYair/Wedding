...
| Tests | `npm test` — **3213+ pass (111 suites)** · 0 Node warnings |
...
tests/               # 3213+ tests: wedding.test.mjs + 111 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3213+ pass, 0 skipped |
