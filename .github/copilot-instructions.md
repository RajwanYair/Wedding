...
| Tests | `npm test` — **2720+ pass (78 suites)** · 0 Node warnings |
...
tests/               # 2720+ tests: wedding.test.mjs + 77 unit/integration files
...
| 2 | **Zero test failures** | `npm test` — all 2720+ pass, 0 skipped |
