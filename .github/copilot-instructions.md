...
| Tests | `npm test` — **4284+ pass (181 suites)** · 0 Node warnings |
...
tests/               # 4284+ tests: wedding.test.mjs + 166 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 4284+ pass, 0 skipped |
