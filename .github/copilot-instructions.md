...
| Tests | `npm test` — **3688+ pass (149 suites)** · 0 Node warnings |
...
tests/               # 3688+ tests: wedding.test.mjs + 148 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3688+ pass, 0 skipped |
