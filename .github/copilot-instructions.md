# GitHub Copilot Instructions — Wedding Manager v5.4.0
...
| Tests | `npm test` — **1590+ pass (19 suites)** · 0 Node warnings |
...
tests/               # 1590+ tests: wedding.test.mjs + 18 unit/integration files
...
| 2 | **Zero test failures** | `npm test` — all 1590+ pass, 0 skipped |
