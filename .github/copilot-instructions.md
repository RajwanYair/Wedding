...
| Tests | `npm test` — **1957+ pass (42 suites)** · 0 Node warnings |
...
tests/               # 1957+ tests: wedding.test.mjs + 41 unit/integration files
...
| 2 | **Zero test failures** | `npm test` — all 1957+ pass, 0 skipped |
