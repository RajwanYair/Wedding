...
| Tests | `npm test` — **4041+ pass (167 suites)** · 0 Node warnings |
...
tests/               # 4041+ tests: wedding.test.mjs + 166 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 4041+ pass, 0 skipped |
