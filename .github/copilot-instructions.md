...
| Tests | `npm test` — **3445+ pass (126 suites)** · 0 Node warnings |
...
tests/               # 3323+ tests: wedding.test.mjs + 118 unit/integration/perf files
...
| 2 | **Zero test failures** | `npm test` — all 3323+ pass, 0 skipped |
