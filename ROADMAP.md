...
> Current baseline: v8.0.0 on main
...
| --- | --- | --- |
| v7.0.0 | 2025-07-12 | Core modular rewrite, 3213 tests / 111 suites |
...
| v8.0.0 | 2025-08-04 | sync-manager, query-builder, deep-merge, cache-manager, string-helpers, schema-validator, event-queue, data-pipeline, presence tests, 4041 tests / 167 suites |
...
| Stylelint | ^18.0.0 | CSS lint | Keep |
