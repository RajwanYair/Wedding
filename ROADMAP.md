...
src/           20 section modules · 10 core modules · 5 services · 6 utils
               ...
               4 i18n JSON files (he, en, ar, ru) · types.d.ts
Tests          1864+ passing (34 suites) · 0 Node warnings
...
| Metric | v4.7.0 Actual | v5.5.0 Actual | Target |
| --- | --- | --- | --- |
| `main.js` lines | ~1,700 | ~707 | ≤ 200 |
| `js/` legacy files | 38 | 0 ✅ | 0 |
| Initial bundle (gzip) | < 30 KB | < 30 KB | < 15 KB |
| RSVP-only bundle (gzip) | < 15 KB | < 15 KB | < 8 KB |
| Lighthouse Performance | ≥ 0.90 | ≥ 0.90 | ≥ 0.98 |
| Lighthouse Accessibility | ≥ 0.95 | ≥ 0.95 | 1.00 |
| Test count | 1,776+ | 1,864+ | 2,500+ |
| Coverage (lines) | ≥ 80% | ≥ 80% | ≥ 90% |
| Type coverage (src/) | 0% | partial (`tsc --noEmit`) | 100% (strict) |
| `window.*` cross-module | 0 | 0 ✅ | 0 |
| Duplicated section lists | 3 | 1 ✅ | 1 |
| Silent failure paths | ~10 | ~0 | 0 |
| Locales | 2 (he, en) | 4 (he, en, ar, ru) ✅ | 4 |
